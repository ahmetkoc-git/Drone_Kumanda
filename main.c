...
/* USER CODE BEGIN PV */
///////////////////Joystick pvs////////////////////////////////
int8_t ROLL_joystick;
int8_t PITCH_joystick;
int8_t YAW_joystick;
int8_t ALTITUDE_joystick;
uint16_t X;
uint16_t Y;
uint16_t Xx;
uint16_t Yy;
...
uint32_t RF_Timer;
const uint32_t RF_Period_ms = 150;
///////////////////SSD1306 PVS/////////////////////////////////
char line[32];
uint32_t OLED_Timer;
const uint32_t OLED_Period_ms = 100;
//////////////////////////////////////////////////////////////
/* USER CODE END PV */
...
void RF_Transmit(){
	...
	void SSD1306_UpdateFlightData(){
		          ...
		          sprintf(line, "CONNECTION: %d", Status_NRF);
		          ssd1306_WriteString(line, Font_7x10, White);
